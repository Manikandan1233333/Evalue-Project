            ...
            try
            {
                ...
                /*if (!Page.IsPostBack)
                {
                    ...
                    if (UserData.Length > 0)
                    {
                        ...
                        {
                            string LocationID = UserData[UserData.Length - 2];
