...
namespace MSCR.Reports
{
	...
	/// </summary>
	public partial class InsLoadXls : System.Web.UI.Page
	{
		...
		public void ItemDataBound2(Object sender, DataGridItemEventArgs e)
		{
			...
			switch(n)
			{
				...
				case 6:
					...
					break;
				case 7:
					e.Item.Cells[5].Text = "'" + drv["Request ID"];
